...
function(build_detect_abi)
  ...
  set(BUILD_OS "${_os}" PARENT_SCOPE)
  set(BUILD_ARCH "${_arch}" PARENT_SCOPE)
  set(BUILD_COMPILER_FAMILY "${_family}" PARENT_SCOPE)
  set(BUILD_COMPILER_FRONTEND_MAJOR "${_frontend_major}" PARENT_SCOPE)
  set(BUILD_STDLIB "${_stdlib}" PARENT_SCOPE)
  set(BUILD_DEPLOYMENT_TARGET "${_dep_target}" PARENT_SCOPE)

  # Compose default triple, allow env override BUILD_TRIPLE / cache override
  set(_triple_default "${_os}-${_arch}-${_cc_tag}")
  set(BUILD_TRIPLE_DEFAULT "${_triple_default}" PARENT_SCOPE)
  ...
  set(BUILD_TRIPLE "${_triple}" PARENT_SCOPE)
endfunction()
...
#     string(APPEND _json "  \"cxxStandard\": ${CMAKE_CXX_STANDARD},\n")
#   else()
#     string(APPEND _json "  \"cxxStandard\": null,\n")
#   endif()
#   if(_STDLIB)
...
#   endif()
  ...
  set(BUILD_ABI_JSON_PATH "${_path}" PARENT_SCOPE)
  set(BUILD_ABI_HASH "${_short}" PARENT_SCOPE)
endfunction()